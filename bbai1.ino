...
const char *ssid = "Meow";  //ENTER YOUR WIFI SETTINGS
const char *password = "paracetamol";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.0.197/biometricattendance/getdata.php"; //computer IP or the server domain
